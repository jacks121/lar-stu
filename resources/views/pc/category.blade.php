...
<head>
    ...
    <meta name="description"
        content="Explore our Range of Engagement Rings at Stunring – Look through our most popular selection of unique and trendy Engagement Rings.Shop now to save more.Large selection of sizes. 30 days risk-free return. Free shipping worldwide." />
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="../../cdn.stunring.com/media/favicon/stores/1/stunring_icon.png" />
...
<body data-container="body"
    ...
    <div id="page-wrapper" class="page-wrapper">
        ...
        <div class="breadcrumbs py-5 ">
            <ul class="items">
                <li class="item home">
                    <a href="https://www.stunring.com/" title="Go&#x20;to&#x20;Home&#x20;Page">
                        Home </a>
                </li>
                <li class="item category21">
                    <a href="https://www.stunring.com/wedding.html" title="">
                        Wedding </a>
                </li>
        ...
        "*": {
            ...
            <div class="category-view">
                <div class="category-image"><img
                        src="https://cdn.stunring.com/media/catalog/category/1220-380---1_1.jpg"
                        alt="Engagement&#x20;Rings" title="Engagement&#x20;Rings" class="image" /></div>
            </div>
            <div class="columns">
                                ...
                                <li class="item product product-item relative">
                                    <div class="product-item-info" data-container="product-grid">
                                        ...
                                        <a href="{{ url()->to('/') . '/product/' . $product['id'] }}.html"
                                            ...
                                            @if (isset($product['images'][1]))
                                                <div class="product-image-hover visually-hidden">
                                                    <img class='w-full' width='350' height='350'
                                        ...
                                        <div class="product details product-item-details">
                                            <div
                                                class="activity-reminder text-sm md:text-base bg-red-50 text-red-700 font-semibold  text-center  rounded leading-7 font-medium mt-2">
                                                Mid-Year sale!</div>
                                            <div class="product-reviews-summary short">
                                                <div class="rating-summary">
                                                    <span class="label"><span>Rating:</span></span>
                                                    <div class="rating-result"
                                                        title="{{ $product['rating_avg'] * 20 }}%">
                                                        <span
                                                            style="width:{{ $product['rating_avg'] * 20 }}%"><span>{{ $product['rating_avg'] * 20 }}%</span></span>
                                                    </div>
                                                </div>
                                                ...
                                                <span class="old-price">
                                                    <span class="price-container price-final_price&#x20;tax">
                                                        ...
                                                        <span id="old-price-{{ $product['id'] }}"
                                                            data-price-amount="{{ $product['original_price'] }}"
                                                            data-price-type="oldPrice" class="price-wrapper "><span
                                                                class="price">${{ $product['original_price'] }}</span></span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                ...
                <div class="sidebar sidebar-main">
                    <div class="block filter" id="layered-filter-block">
                        ...
                        <div id="ln_overlay" class="ln_overlay">
                            <div class="loader">
                                <img src="/static/version1681280332/frontend/Swetelove/desktop/en_US/images/loader-1.gif"
                                    alt="Loading...">
                            </div>
                        </div>
